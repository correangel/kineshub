...
<!-- Basic dropdown -->
  ...
  <input class="form-control my-0 py-1 buscador1" type="text" placeholder="Buscar <?= $num ?> Anuncios" autocomplete="off" aria-label="Search" id="buscar_texto" onkeyup="filtrar_busqueda()">
