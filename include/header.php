...
<!-- Basic dropdown -->
  ...
  <input class="form-control my-0 py-1 buscador1" type="text" placeholder="Buscar <?= $num ?> Anuncios" autocomplete="off" aria-label="Search" autocomplete="nope" name="buscador_super_pro_idfjifjbvdfbvfgbdf" value="" id="buscar_texto" onkeyup="filtrar_busqueda()">
...
<nav class="navbar navbar-light d-block d-md-none d-flex align-items-center" >
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent20">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item ">
      <a href="iniciodesesion.php" class="nav-link"class="nav-link"><i class="fas fa-tag"></i> Publicar Anuncio</a>
