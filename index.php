...
<body>
 ...
 <div class="container-fluid ">
  ...
  <input class="form-control my-0 py-1 buscador1" type="text" autocomplete="nope" name="buscador_super_pro_idfjifj" placeholder="Buscar <?= $num ?> Anuncios" aria-label="Search" value="">
