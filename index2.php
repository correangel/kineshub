   ...
   <div class="row  " id="filtrar">
    <!-- copiar desde aqui  -->
     <div class="col-lg-2 col-6">
       <div class="card">
         <img src="images/1608155188.png" class="imagen2x" alt="">
         <div class="card-body">
          <div class="row ">
            <div class="col-8">
              <div class="row">
  <div class="col-12 " ><p>Judith </p></div>
       ...
       <div>
          <span class="badge badge-pill badge-light">Lince</span>
          <span class="badge badge-pill badge-light">20 años</span>
          <span class="badge badge-pill badge-light">S/ 0</span>
          <span class="badge badge-pill badge-light">Peruana</span>
        </div>
        </div>
       </div>
        <!-- <div class="row mt-4" id="load_data_message"></div>  esto no se q es-->
     </div>
