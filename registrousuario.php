		...
		<form>
			<div class="row flex-center">
				<div class="col-12  pl-4 pr-2">
					<input class="form-control campo1  w-100 f1" type="text" id="usuario" name="usuario" placeholder="Nombre de Usuario">
				</div>

				<div class="col-12  pl-4 pr-2 mt-3">
					<input class="form-control w-100 campo1  f1" type="text" id="correo" name="correo" placeholder="Correo Electronico">
				</div>
				<div class="col-12  pl-4 pr-2 mt-3">
					
					<input class="form-control w-100 f1 campo1" type="password" id="contraseña1" name="contraseña1" placeholder="Contraseña">
				
				</div>
				<div class="col-12  pl-4 pr-2 mt-3">
					
					<input class="form-control w-100 f1 campo1" type="password" id="confirmarcontraseña" name="confirmarcontraseña" placeholder="Confirmar contraseña">
